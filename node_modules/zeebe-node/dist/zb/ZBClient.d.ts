...
export declare class ZBClient extends TypedEmitter<typeof ConnectionStatusEvent> {
     ...
     * ```
     */
    createProcessInstance<Variables extends ZB.JSONDoc = ZB.IProcessVariables>(bpmnProcessId: string, variables: Variables): Promise<Grpc.CreateProcessInstanceResponse>;
     ...
     * ```
     */
    createProcessInstanceWithResult<Variables extends ZB.JSONDoc = ZB.IInputVariables, Result = ZB.IOutputVariables>(bpmnProcessId: string, variables: Variables): Promise<Grpc.CreateProcessInstanceWithResultResponse<Result>>;
    ...
    createProcessInstanceWithResult<Variables extends ZB.JSONDoc = ZB.IProcessVariables, Result = ZB.IOutputVariables>(bpmnProcessId: string, variables: Variables): Promise<Grpc.CreateProcessInstanceWithResultResponse<Result>>;
    /**
     *
