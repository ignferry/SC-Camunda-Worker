...
class ZBClient extends TypedEmitter_1.TypedEmitter {
    ...
    evaluateDecision(evaluateDecisionRequest) {
        ...
        return this.executeOperation('evaluateDecision', () => this.grpc.evaluateDecisionSync({ ...evaluateDecisionRequest, variables }));
    }
    /**
     *
    ...
    publishMessage(publishMessageRequest) {
        return this.executeOperation('publishMessage', () => this.grpc.publishMessageSync((0, lib_1.stringifyVariables)({
